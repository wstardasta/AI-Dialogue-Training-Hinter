...
class AIChatHelper {
     ...
     */
    static async copyToClipboardForAI(prompt) {
     ...
     * 基于选中的代码生成AI对话提示词
     */
    static async generateAIPromptFromCode(context) {
        if (!context) {
            context = await codeAnalyzer_1.CodeAnalyzer.getCurrentCodeContext() || undefined;
        }
        ...
        // 生成适合AI对话的提示词
        const prompt = await codeAnalyzer_1.CodeAnalyzer.generatePromptFromCode(context);
        return prompt;
    }
    /**
     * 快速发送提示词到AI（复制到剪贴板）
     */
    static async quickSendToAI(prompt) {
     ...
     * 显示提示词选择器，选择后复制到剪贴板
     */
    static async showPromptSelector(prompts) {
...
exports.AIChatHelper = AIChatHelper;
//# sourceMappingURL=aiChatHelper.js.map